...
Ihr findet auf diesen Seiten die Checklisten zu den Themen in den einzelnen Klassen (als pdf). Dazu sind hier Aufgaben zur Wiederholung angegeben. Ihr könnt euch dazu die Lösungen und weitere Anmerkungen oder z.B. auch Rechnungen anschauen.
...
Wenn Sie Ihre Antwort formuliert haben, geben Sie "vergleichen" in den unteren Kasten ein und drücken Sie "Check". Wenn Sie die Musterlösung nicht sehen, drücken "i".
...
a) Formulieren Sie die Teil- und Gesamtgleichung für diese Reaktion.

b) Ordnen Sie die Begriffe: Oxidation, Reduktion, Oxidationsmittel, Reduktionsmittel, Elektronendonator und Elektronenakzeptor zu.


Gehen Sie oben über die Pfeile "<" und ">" eine Seite weiter, um die Lösungen zu sehen.

##Reaktionsgleichungen

Wenn Sie die Reaktionsgleichungen formuliert haben, können Sie "fertig" eingeben, um die Musterlösung zu sehen.
...
> ![image](../graphics/08_Pfeilbild_Flaecheninhalt.png)
...
> ![image](../graphics/08_Quadrat_U_A_1.png)
...
> ![image](../graphics/08_Rechteck_U_A_1.png)
...
> ![image](../graphics/08_Einheitentabelle_Flaecheneinheiten.png)
